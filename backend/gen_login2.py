import os
p = r'd:\Desktop\AI\u4f1a\u8bae\smartsync\frontend\src\views\Login.vue'
L = [
  '<template>',
  ...
  '        <div>',
  '          <h1 class="brand-name">SmartSync</h1>',
  '          <p class="brand-sub">\u667a\u80fd\u4f1a\u8bae\u6d1e\u5bdf\u4e0e\u4efb\u52a1\u4e2d\u67a2</p>',
  '        </div>',
  '      </div>',
  ...
  '        <el-button type="primary" native-type="submit" class="login-btn" :loading="loading" size="large" round>',
  '          \u767b\u5f55\u7cfb\u7edf',
  '        </el-button>',
  '      </el-form>',
...
with open(p, 'w', encoding='utf-8') as f:
    f.write('\n'.join(L) + '\n')
print('Login.vue OK, lines:', len(L))